const CV_DATA = {
  ...
  profile: {
    ...
    summary: {
      es: "Ingeniero de datos con más de 14 años de experiencia en business intelligence, big data e inteligencia artificial. Me muevo con comodidad entre el liderazgo técnico y el código: diseño arquitecturas de datos, construyo pipelines robustos e integro múltiples fuentes para convertir datos en producto. Últimamente combino todo esto con IA generativa y programación agéntica para automatizar procesos y acelerar la entrega de valor.",
      en: "Data engineer with 14+ years of experience across business intelligence, big data and artificial intelligence. I move comfortably between technical leadership and hands-on code: I design data architectures, build robust pipelines and integrate multiple sources to turn data into product. Lately I combine all of this with generative AI and agentic programming to automate processes and accelerate value delivery."
    },
    contact: {
  ...
  personal_projects: [
    ...
    },
    {
      name: "Odportunity",
      description: {
        es: "Landing page de odportunity.com: servicio que detecta oportunidades de valor en apuestas deportivas en directo y avisa por Telegram cuando una cuota corta sube a un valor objetivo (2.00 por defecto). HTML estático bilingüe ES/EN con Tailwind (CDN), sin build step, desplegado en Cloudflare Pages.",
        en: "Landing page for odportunity.com: a service that detects value opportunities in live sports betting and pings users on Telegram when a short price climbs to a target value (default 2.00). Bilingual ES/EN single-file HTML with Tailwind (CDN), no build step, deployed on Cloudflare Pages."
      },
      stack: ["HTML", "Tailwind CSS", "Vanilla JS", "Cloudflare Pages"],
      url: "https://www.odportunity.com",
      year: "2026",
      status: "live"
    },
    {
